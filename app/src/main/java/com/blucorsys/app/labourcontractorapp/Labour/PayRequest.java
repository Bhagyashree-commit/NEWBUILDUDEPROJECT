...
public class PayRequest extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_pay_request, container, false);
        rv_paymentlist=v.findViewById(R.id.rv_paymentlist);
    ...
    public void setAdapter(RecyclerView mRecyclerview)
    {
        ...
        mRecyclerview.setAdapter(new PayRequest.ApplyJobAdapter(joblist));
    }

    //*Recyclerview Adapter*//
    private class ApplyJobAdapter extends RecyclerView.Adapter<PayRequest.Holder> {
        ...
        public PayRequest.Holder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new PayRequest.Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.pay_list, parent, false));
        }
        @Override
        public void onBindViewHolder(@NonNull final PayRequest.Holder holder, final int position) {
